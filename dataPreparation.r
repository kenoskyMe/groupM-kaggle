...
currentTrainPath = 'Users/kenosky/Documents/R/groupM-kaggle/train.csv'
currentTestPath = 'Users/kenosky/Documents/R/groupM-kaggle/test_v2.csv'

training = T
if (training)
{
  data = read.csv('Users/kenosky/Documents/R/groupM-kaggle/train.csv',header=T)
} else {
  load(currentTrainPath)
  rm(data)
  data = read.csv('Users/kenosky/Documents/R/groupM-kaggle/test_v2.csv',header=T)
}
